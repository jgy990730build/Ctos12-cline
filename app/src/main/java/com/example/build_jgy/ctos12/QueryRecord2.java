...
public class QueryRecord2 extends AppCompatActivity {
    ImageButton button;
    EditText editText;
    List<Student> list2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.query_record2);
                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            // URl是接口地址
                            HttpPost httpPost = new HttpPost("http://172.16.156.35:8080/Android/Query_st_Record_id");//服务器接口地址
                            // 将请求体内容加入请求中
                            ...
                            if(list2.size()!=0){
//                                Intent intent = new Intent(QueryRecord2.this, result.class);
//                                intent.putExtra("result",(Serializable) list2);
//                                QueryRecord2.this.startActivityForResult(intent,16);
//                                QueryRecord2.this.finish();
                                ...
                                Looper.prepare();
                                Toast.makeText(QueryRecord2.this,"没有此学生信息！",Toast.LENGTH_SHORT).show();
                                Looper.loop();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
